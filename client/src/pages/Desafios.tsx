...
const Desafios = () => {
  ...
  const completedCount = useMemo(() => {
    ...
    return challenges.filter((challenge: any) => progressMap.get(challenge.id))
      .length;
    ...
    if (userScore && !scoreLoading) {
      ...
      if (previousRankRef.current && previousRankRef.current !== currentRank) {
        ...
        if (
          ...
          rankOrder[previousRankRef.current as keyof typeof rankOrder]
        ) {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Complete os desafios abaixo e construa hábitos sustentáveis que
            fazem a diferença!
          </p>
        </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-800">
                  {completedCount} de {challenges?.length || 0} Desafios
                  Concluídos
                </h2>
                <p className="text-gray-600">
                  Continue assim! Cada ação conta para um planeta melhor.
                </p>
              </div>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Use IA para criar novos desafios sustentáveis personalizados
              </p>
            </div>
            <Button
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100">
                  Continue completando desafios para subir de rank!
                </p>
              </div>
              <RankMedal
                rank={userScore.rank}
          ...
          challenges.length > 0 && (
            <div className="mt-8 bg-green-600 text-white p-8 rounded-lg text-center">
              ...
              <p className="text-green-100">
                Você completou todos os desafios! Seu compromisso com a
                sustentabilidade está fazendo a diferença.
              </p>
            </div>
          )}
      </div>
